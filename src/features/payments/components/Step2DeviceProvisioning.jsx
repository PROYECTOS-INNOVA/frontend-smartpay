...
const Step2DeviceProvisioning = ({ onNext, onBack, initialData = {} }) => {
  ...
  const generateProvisioningJson = (enrolmentId) => ({
    ...
    "android.app.extra.PROVISIONING_DEVICE_ADMIN_SIGNATURE_CHECKSUM": "AW_qCv-ru6MqdT15FX8Cg4Zy1asTDUBYrKfx2lsOvOw=",
    ...
    "android.app.extra.PROVISIONING_DEVICE_ADMIN_PACKAGE_CHECKSUM": "AW_qCv-ru6MqdT15FX8Cg4Zy1asTDUBYrKfx2lsOvOw=",
