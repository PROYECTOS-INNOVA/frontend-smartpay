            ...
            <Dialog as="div" className="relative z-50" onClose={onClose}>
                ...
                <div className="fixed inset-0 overflow-y-auto">
                    <div className="flex min-h-full items-center justify-center p-4 text-center">
                        ...
                        >
                            <Dialog.Panel className="w-11/12 md:max-w-4xl transform rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all overflow-visible">
                                <Dialog.Title
                                    as="h3"
                                ...
                                <div className="mt-4">
                                    <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                        ...
                                        <div className="relative" ref={cityInputRef}>
                                            ...
                                            {!formData.country_id && formData.country_name_input && !showSuggestionsCountry && (
